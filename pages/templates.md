...
<table class="sortable">
  ...
  <tr>
    <th class="row-header" scope="row">Readiness Assessment Phase</th>
  ...
  <tr>
    <th class="row-header" scope="row">Initial Authorization Phase- Initial Authorization Package Checklist</th>
  ...
  <tr>
    <th class="row-header" scope="row">Initial Authorization Phase- Document: System Security Plan (SSP)</th>
...
<p class="icon-text">EXCEL</p></a>
  ...
  <tr>
    <th class="row-header" scope="row">Initial Authorization Phase- Assess: Security Assessment Plan (SAP)</th>
...
<td>3/10/2017</td>
  ...
  <tr>
<th class="row-header" scope="row">Initial Authorization Phase- Authorize: Security Assessment Report (SAR)</th>
...
<p class="icon-text">EXCEL</p></a>
  ...
  <tr>
    <th class="row-header" scope="row">Initial Authorization Phase- Authorize: Plan of Action and Milestones (POA&amp;M)</th>
...
<p class="icon-text">EXCEL</p></a>
  ...
  <tr>
<th class="row-header" scope="row">Initial Authorization Phase- Authorize: Agency Authorization Review Report Sample Template</th>
...
<td>6/20/2019</td>
  ...
  <tr>
    <th class="row-header" scope="row">Initial Authorization Phase- Authorize: FedRAMP ATO Letter Template</th>
...
<p class="icon-text">WORD</p></a>
  ...
  <tr>
    <th class="row-header" scope="row">Continuous Monitoring Phase</th>
...
<p class="icon-text">EXCEL</p></a>
  ...
  <tr>
    <th class="row-header" scope="row">FedRAMP Tailored</th>
