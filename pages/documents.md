...
<table class="sortable">
  ...
  <tr>
    <th class="row-header" scope="row">FedRAMP Program Documents</th>
...
Designation of FedRAMP 3PAO accreditation and FedRAMP Security Authorization</td>
    ...
    <tr>
    <th class="row-header" scope="row">Key Cloud Service Provider (CSP) Documents</th>
  ...
  <tr>
    ...
    <td>The FedRAMP POA&amp;M Template Completion Guide provides explicit guidance on how to complete the POA&apm;M Template and provides guidance to ensure that the CSP is meeting POA&amp;M requirements. </td>
  ...
  <tr>
    <th class="row-header" scope="row">Key Assessor Documents</th>
