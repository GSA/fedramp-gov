...
<li>
    ...
    <i></i>
<h3>1) How does FedRAMP handle TIC requirements in the cloud?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>2) Are there specific categories of routine/non-routine changes?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>3) How long does a CSP have to remediate a POA&M and does this apply to all system levels?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>4) For cloud services that are authorized, what happens if the CSP changes the infrastructure of the system?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>5) Are cloud services that are listed as "In-Process" considered FedRAMP compliant?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>6) If an Agency purchases an outsourced service (software) that is built on top of a cloud platform, how is that handled within FedRAMP?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>7) Who is responsible for the cloud security controls?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>8) During an assessment, are "on the spot" fixes acceptable? Or will it still need to be written up?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>9) Are third-party vendors required to be FedRAMP authorized?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>10) If an Agency adds additional security controls, how can other Agencies leverage those additional controls?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>11) Our cloud structure is served from a cloud service that is already FedRAMP compliant. Is there is a shorter process to FedRAMP approval since we use an already-approved platform?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>12) Is continuous monitoring periodically reported or a real-time monitoring of critical metrics?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>13) What are the different types of authorization and how are they issued?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>14) What is the distinction between "FedRAMP Authorized" and “FedRAMP Ready”? How do Agencies access and approve security authorization packages?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>15) What is the relationship between FedRAMP and other security frameworks?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>16) How does an Agency leverage an existin****g FedRAMP JAB or Agency a****uthorization package?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>17) Why should a CSP use an independent assessment organization and when is it required?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>18) How is the continuous monitoring process for an Agency ATO governed?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>19) How does a company become a FedRAMP accredited Third Party Assessment Organization (3PAO)? How is the independence and quality of a 3PAO validated? Who pays for the 3PAO’s services?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>20) Who can access the secure repository to view authorization packages?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>22) What are the requirements to use the FedRAMP logo on a CSP’s marketing materials?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>23) Do the FedRAMP security controls restrict data to reside only within the United States?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>24) Who will do the continuous monitoring and ongoing authorization of the cloud systems that have been authorized by an Agency?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>25) Is a penetration test required for FedRAMP ATO?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>26) My company is looking to obtain FedRAMP certification for one of our existing cloud products. I have executive support and an Agency sponsor. How do I get started?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>27) Where are all the FedRAMP documentations maintained and will there be a notification system to alert the FedRAMP community of the posting of new documents for public comment?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>28) How will FedRAMP help make cloud computing more secure for the federal government?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>29) Is the cost of a FedRAMP authorization a barrier to entry for small businesses?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>30) Who published the latest version SP 800-53 Rev 4 and what security risk concerns do the security controls cover?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>31) Can a non-accredited 3PAO provide readiness assessment services to CSPs prior to an accredited 3PAO assessing them for FedRAMP?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>32) What is the role of the 3PAO in continuous monitoring?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>33) What mechanisms are in place for agencies to manage CSPs that are about to lose their cloud service’s authorization?</h3>
...
<li>
    <input type="checkbox" checked>
    <i></i>
<h3>34) Who are the Authorized FedRAMP Approvers for Federal Agencies?</h3>
