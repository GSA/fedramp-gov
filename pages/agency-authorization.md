...
In this phase, a CSP formalizes their partnership with an Agency via FedRAMP's In Process Requirements detailed in <a href="{{site.baseurl}}/assets/resources/documents/FedRAMP_Marketplace_Guidance_for_CSPs.pdf">FedRAMP's Marketplace Guidance for Cloud Service Providers</a>. In some cases, a vendor may be under contract with a Agency already, or an Agency may be working through the acquisition process.
