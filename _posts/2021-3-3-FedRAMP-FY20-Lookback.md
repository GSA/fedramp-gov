...
<img  alt="FedRAMP FY2020 Year End Infographic" title="FedRAMP 2020 Year End Infographic" src="{{site.baseurl}}/assets/img/FedRAMP-FY20-Infographic.png" style="margin: 20px auto; max-width: 500px; width: 100%; display: block;">
